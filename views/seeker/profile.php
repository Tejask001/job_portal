...
<div class="container mt-4">
    <h1 class="mb-4 text-center">Update Your Profile</h1>
                ...
                <ul class="list-group list-group-flush">
                    <?php foreach ($resumes as $resume): ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo generate_url('controllers/UserController.php?action=delete_resume&id=' . html_escape($resume['id'])); ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure?');">Delete</a>
                        </li>
                    <?php endforeach; ?>
                </ul>
            <?php endif; ?>
    ...
    <div class="card">
        <div class="card-body text-center">
            ...
            <div class="d-flex justify-content-center gap-3">
                ...
                <a href="<?php echo generate_url('controllers/UserController.php?action=delete_account'); ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete your account?');">Delete Account</a>
            </div>
        </div>
    </div>
</div>
