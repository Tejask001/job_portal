    ...
    <div class="container-fluid bg-light py-5">
        <div class="container">
            <div class="alert alert-warning" role="alert">
                <i class="bi bi-exclamation-triangle me-2"></i> No companies found. Please create a company first.
            </div>
        </div>
    </div>
<?php
...
<div class="container-fluid bg-light py-5">
    <div class="container d-flex justify-content-center bg-light"> <!-- Centering Container -->
        <div class="card shadow-lg border-0 rounded-lg w-75">
            <div class="card-header bg-primary text-white text-center py-3">
                <h3 class="mb-0"><i class="bi bi-plus-circle me-2"></i> Post Job as Company</h3>
            </div>
            <div class="card-body">
                <form action="<?php echo generate_url('controllers/JobController.php?action=post_job'); ?>" method="post">
                    ...
                    <div class="mb-3">
                        <label for="company_id" class="form-label"><i class="bi bi-building me-1"></i> Select Company:</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="posting_type" class="form-label"><i class="bi bi-tag me-1"></i> Posting Type:</label>
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="employment_type" class="form-label"><i class="bi bi-briefcase me-1"></i> Employment Status:</label>
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="work_type" class="form-label"><i class="bi bi-laptop me-1"></i> Work Arrangement:</label>
                    ...
                    <div class="mb-3">
                        <label for="skills" class="form-label"><i class="bi bi-tools me-1"></i> Skills Required (Comma-separated):</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="job_location" name="job_location" placeholder="e.g., City, State" required>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="stipend_salary" name="stipend_salary" placeholder="Enter stipend or salary" required>
                        </div>

                    </div>

                    <div class="mb-3">
                        <label for="perks" class="form-label"><i class="bi bi-gift me-1"></i> Perks (Comma-separated):</label>
                    ...
                    <button type="submit" class="btn btn-primary"><i class="bi bi-cloud-arrow-up me-1"></i> Post Job</button>
                </form>
            </div>
        </div>
    </div>
